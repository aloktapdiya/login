...
public class SwaggerConfig {
    ...
    @Bean
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis((java.util.function.Predicate<RequestHandler>) RequestHandlerSelectors.basePackage("com.course5i.base.framework")).paths((java.util.function.Predicate<String>) PathSelectors.any()).build().apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Product REST API", "Product API to perform CRUD opertations", "1.0", "Terms of service",
                new Contact("Java ", "www..com", "mail.com"), "License of API", "API license URL", Collections.emptyList());
    }
